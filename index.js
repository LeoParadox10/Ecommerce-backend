...
mongoose.connect("mongodb+srv://smarakpatra2711:leoparadox_10@cluster0.uwquv1w.mongodb.net/e-commerce-mern")
...
app.post("/upload", upload.single('product'), (req, res) => {
    res.json({
        success: 1,
        image_url: `https://ecommerce-backend-b9t1.onrender.com/images/${req.file.filename}`
    })
})
